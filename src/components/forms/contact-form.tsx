  ...
  return (
    <div className={cn('bg-white rounded-xl shadow-lg p-8', className)}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        {showPropertyFields && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <select {...register('propertyType')} id="propertyType"
        ...
        {/* ─── SMS Opt-In — A2P carrier compliance ────────────────────────────────
            • Standalone checkbox, visually distinct from the submit button
            • Unchecked by default
            • NOT required to submit the form
            • NOT bundled into ToS or any purchase condition
        ──────────────────────────────────────────────────────────────────────── */}
        <div
          className={cn(
            'rounded-xl border-2 p-5 transition-colors',
            smsConsent ? 'border-brand-blue bg-blue-50' : 'border-gray-200 bg-gray-50',
          )}
          role="group"
        ...
        {challengeEnabled ? (
          <div>
            <p className="block text-sm font-medium text-gray-700 mb-2">
              Human verification <span aria-hidden="true">*</span>
            </p>
